...
// NullPointerException : 참조 변수가 null 인 상태에서
// 필드나 메서드에 접근할 경우 발생하는 예외
public class ExceptionHandlingExample1 {
	
	// 문자열 데이터를 전달 받아서 문자열의 길이가 얼마인지 출력하는 메서드 작성하기
	public static void printLength(String data) {
		...
		try {
			...
			// 예외가 발생하면 발생한 예외 클래스의 객체가 만들어지게 된다.
			// 그 객체가 catch 의 매개변수로 들어온다.
