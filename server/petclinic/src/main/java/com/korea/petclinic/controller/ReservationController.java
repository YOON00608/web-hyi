...
public class ReservationController {
    ...
    @GetMapping("/{id}")
    public ReservationVO findById(@PathVariable("id") Long id) {
    ...
    @PutMapping("/{id}")
    public int update(@PathVariable("id") Long id, @RequestBody ReservationVO reservation) {
        reservation.setId(id); // URL의 id를 VO 객체에 주입
    ...
    public List<ReservationVO> searchDetail(@RequestParam("searchType") String searchType, 
    ...
    @GetMapping("/sort")
    public List<ReservationVO> sortByPrice(@RequestParam("sort") String sort) {
